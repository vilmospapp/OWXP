...
@Component(
		  ...
		  service = BadgeNotificationScheduler.class
		)
public class BadgeNotificationScheduler extends BaseMessageListener {
		  ...
		  private static final Log _log = LogFactoryUtil.getLog(BadgeNotificationScheduler.class);
