...
import com.liferay.grow.gamification.service.LDateService;
...
/**
 * Provides the base implementation for the l date remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.grow.gamification.service.impl.LDateServiceImpl}.
 * </p>
 *
 * @author Vilmos Papp
 ...
 * @generated
 */
public abstract class LDateServiceBaseImpl extends BaseServiceImpl
	implements LDateService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.liferay.grow.gamification.service.LDateServiceUtil} to access the l date remote service.
	 */
	 ...
	 */
	public LDateService getLDateService() {
		return lDateService;
	}
	 ...
	 */
	public void setLDateService(LDateService lDateService) {
	...
	public String getOSGiServiceIdentifier() {
		return LDateService.class.getName();
	}
	...
	@BeanReference(type = LDateService.class)
	protected LDateService lDateService;
