...
/**
 * Provides the remote service interface for LDate. Methods of this
...
@OSGiBeanProperties(property =  {
	"json.web.service.context.name=gamification", "json.web.service.context.path=LDate"}, service = LDateService.class)
@ProviderType
@Transactional(isolation = Isolation.PORTAL, rollbackFor =  {
	PortalException.class, SystemException.class})
public interface LDateService extends BaseService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
