...
/**
 * Provides the local service interface for Subscriber. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Vilmos Papp
 * @see SubscriberLocalServiceUtil
...
public interface SubscriberLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SubscriberLocalServiceUtil} to access the subscriber local service. Add custom service methods to {@link com.liferay.grow.gamification.service.impl.SubscriberLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
