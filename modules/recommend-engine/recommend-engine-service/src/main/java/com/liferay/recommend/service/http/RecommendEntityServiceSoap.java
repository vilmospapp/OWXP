 ...
 * is translated to an array of {@link com.liferay.recommend.model.RecommendEntitySoap}.
 * If the method in the service utility returns a
 * {@link com.liferay.recommend.model.RecommendEntity}, that is translated to a
 * {@link com.liferay.recommend.model.RecommendEntitySoap}. Methods that SOAP cannot
 ...
 * @see RecommendEntityServiceHttp
 * @see com.liferay.recommend.model.RecommendEntitySoap
...
public class RecommendEntityServiceSoap {
	...
	*/
	public static String getTopMostViewed(int resultCount,
		...
		try {
			com.liferay.portal.kernel.json.JSONObject returnValue = RecommendEntityServiceUtil.getTopMostViewed(resultCount,
					serviceContext);
	...
	private static Log _log = LogFactoryUtil.getLog(RecommendEntityServiceSoap.class);
}