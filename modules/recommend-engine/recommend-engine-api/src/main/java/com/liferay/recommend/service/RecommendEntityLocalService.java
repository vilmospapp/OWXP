...
/**
 * Provides the local service interface for RecommendEntity. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RecommendEntityLocalServiceUtil
...
public interface RecommendEntityLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RecommendEntityLocalServiceUtil} to access the recommend entity local service. Add custom service methods to {@link com.liferay.recommend.service.impl.RecommendEntityLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public RecommendEntity addRecommendEntity(RecommendEntity recommendEntity);
	...
	*/
	...
	public RecommendEntity deleteRecommendEntity(long id)
		throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RecommendEntity fetchRecommendEntity(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RecommendEntity> getRecommendEntities(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public RecommendEntity updateRecommendEntity(
		RecommendEntity recommendEntity);
}