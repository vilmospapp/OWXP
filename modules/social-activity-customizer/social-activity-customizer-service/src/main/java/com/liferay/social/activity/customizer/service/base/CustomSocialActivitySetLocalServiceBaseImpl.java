...
/**
 * Provides the base implementation for the custom social activity set local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.social.activity.customizer.service.impl.CustomSocialActivitySetLocalServiceImpl}.
 * </p>
 *
...
public abstract class CustomSocialActivitySetLocalServiceBaseImpl
	...
	public CustomSocialActivitySet fetchCustomSocialActivitySet(long id) {
		return customSocialActivitySetPersistence.fetchByPrimaryKey(id);
	}
	...
	public int getCustomSocialActivitySetsCount() {
		return customSocialActivitySetPersistence.countAll();
	}
	...
	/**
	 * Returns the custom social activity set local service.
	 *
	...
	/**
	 * Sets the custom social activity set local service.
	 *
	...
	/**
	 * Returns the custom social activity set finder.
	 *
	 * @return the custom social activity set finder
	 */
	public CustomSocialActivitySetFinder getCustomSocialActivitySetFinder() {
		return customSocialActivitySetFinder;
	}

	/**
	 * Sets the custom social activity set finder.
	 *
	 * @param customSocialActivitySetFinder the custom social activity set finder
	 */
	...
	public String getOSGiServiceIdentifier() {
		return CustomSocialActivitySetLocalService.class.getName();
	}
