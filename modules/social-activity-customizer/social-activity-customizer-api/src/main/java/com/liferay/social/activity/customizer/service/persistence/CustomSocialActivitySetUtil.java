...
/**
 * The persistence utility for the custom social activity set service. This utility wraps <code>com.liferay.social.activity.customizer.service.persistence.impl.CustomSocialActivitySetPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CustomSocialActivitySetUtil {
	 ...
	 */
	public static Map<Serializable, CustomSocialActivitySet> fetchByPrimaryKeys(
	...
	public static CustomSocialActivitySet remove(long id)
		throws com.liferay.social.activity.customizer.exception.
			NoSuchCustomSocialActivitySetException {
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(
			CustomSocialActivitySetPersistence.class);

		ServiceTracker
			<CustomSocialActivitySetPersistence,
			 CustomSocialActivitySetPersistence> serviceTracker =
				new ServiceTracker
					<CustomSocialActivitySetPersistence,
					 CustomSocialActivitySetPersistence>(
						 bundle.getBundleContext(),
						 CustomSocialActivitySetPersistence.class, null);
